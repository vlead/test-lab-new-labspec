		...
		for( i = 0 ;  i < f ; i++ ){
			...
			if( Character.isDigit(cur) ||  cur=='-' ){
				...
				if(state == 0 || state==5){
					...
					operations[res] = operations[res].concat("<p style='color:blue;'>In Logical Representation:<br></p><b style='font-size:14;'><span style='color:#006600;'>"
	+b2 +" </span><span style='color:#ff3300;'>" +fexpr[i]+ " </span><span style='color:#ff00ff;'>" + b1 +"</span> = <span style='color:#6633ff;'>" + btmp +"</span></b></center>");
					if(state !=5)
						temp1.in = 0;
					else
						temp1.in = 5;
